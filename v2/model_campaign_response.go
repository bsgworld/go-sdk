...
func (o *CampaignResponse) GetData() CampaignSchema {
...
func (o *CampaignResponse) GetDataOk() (*CampaignSchema, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *CampaignResponse) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *CampaignResponse) SetData(v CampaignSchema) {
	o.Data = &v
}
