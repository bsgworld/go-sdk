...
// checks if the ViberPricesResponsePricesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViberPricesResponsePricesInner{}

// ViberPricesResponsePricesInner Pricing entry for a specific destination
type ViberPricesResponsePricesInner struct {
	// Message type (always \"viber\" for this API)
	...
	Mnc string `json:"mnc"`
	// Price per message with 7 decimal precision
	Price string `json:"price" validate:"regexp=^[0-9]+\\\\.[0-9]{7}$"`
	// Currency code (ISO 4217)
	Currency string `json:"currency" validate:"regexp=^[A-Z]{3}$"`
}

type _ViberPricesResponsePricesInner ViberPricesResponsePricesInner
...
func NewViberPricesResponsePricesInner(type_ string, country string, countryName string, mcc string, mnc string, price string, currency string) *ViberPricesResponsePricesInner {
	this := ViberPricesResponsePricesInner{}
	this.Type = type_
...
func (o ViberPricesResponsePricesInner) MarshalJSON() ([]byte, error) {
...
func (o ViberPricesResponsePricesInner) ToMap() (map[string]interface{}, error) {
...
func (o *ViberPricesResponsePricesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varViberPricesResponsePricesInner := _ViberPricesResponsePricesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varViberPricesResponsePricesInner)

	if err != nil {
		return err
	}

	*o = ViberPricesResponsePricesInner(varViberPricesResponsePricesInner)

	return err
}

type NullableViberPricesResponsePricesInner struct {
	value *ViberPricesResponsePricesInner
	isSet bool
}

func (v NullableViberPricesResponsePricesInner) Get() *ViberPricesResponsePricesInner {
	return v.value
}

func (v *NullableViberPricesResponsePricesInner) Set(val *ViberPricesResponsePricesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableViberPricesResponsePricesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableViberPricesResponsePricesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViberPricesResponsePricesInner(val *ViberPricesResponsePricesInner) *NullableViberPricesResponsePricesInner {
	return &NullableViberPricesResponsePricesInner{value: val, isSet: true}
}

func (v NullableViberPricesResponsePricesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViberPricesResponsePricesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
