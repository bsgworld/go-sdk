...
// checks if the TwoFactorAuthenticationMessagesResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TwoFactorAuthenticationMessagesResource{}

// TwoFactorAuthenticationMessagesResource struct for TwoFactorAuthenticationMessagesResource
type TwoFactorAuthenticationMessagesResource struct {
	...
	Messages []TwoFactorMessageResource `json:"messages,omitempty"`
}
...
func NewTwoFactorAuthenticationMessagesResource() *TwoFactorAuthenticationMessagesResource {
	this := TwoFactorAuthenticationMessagesResource{}
	return &this
}
...
func (o *TwoFactorAuthenticationMessagesResource) SetSenderAltNil() {
	o.SenderAlt.Set(nil)
}
...
func (o *TwoFactorAuthenticationMessagesResource) GetMessages() []TwoFactorMessageResource {
	if o == nil || IsNil(o.Messages) {
		var ret []TwoFactorMessageResource
		return ret
	}
	return o.Messages
}
...
// SetMessages gets a reference to the given []TwoFactorMessageResource and assigns it to the Messages field.
func (o *TwoFactorAuthenticationMessagesResource) SetMessages(v []TwoFactorMessageResource) {
	o.Messages = v
}

func (o TwoFactorAuthenticationMessagesResource) MarshalJSON() ([]byte, error) {
...
func (o TwoFactorAuthenticationMessagesResource) ToMap() (map[string]interface{}, error) {
...
type NullableTwoFactorAuthenticationMessagesResource struct {
	value *TwoFactorAuthenticationMessagesResource
	isSet bool
}

func (v NullableTwoFactorAuthenticationMessagesResource) Get() *TwoFactorAuthenticationMessagesResource {
	return v.value
}

func (v *NullableTwoFactorAuthenticationMessagesResource) Set(val *TwoFactorAuthenticationMessagesResource) {
	v.value = val
	v.isSet = true
}

func (v NullableTwoFactorAuthenticationMessagesResource) IsSet() bool {
	return v.isSet
}

func (v *NullableTwoFactorAuthenticationMessagesResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTwoFactorAuthenticationMessagesResource(val *TwoFactorAuthenticationMessagesResource) *NullableTwoFactorAuthenticationMessagesResource {
	return &NullableTwoFactorAuthenticationMessagesResource{value: val, isSet: true}
}

func (v NullableTwoFactorAuthenticationMessagesResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTwoFactorAuthenticationMessagesResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
